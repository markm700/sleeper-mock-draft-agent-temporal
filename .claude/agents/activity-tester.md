...
description: Use to design and maintain pytest coverage for Temporal activities, workflows, and their clients under src/. Invoke when a new or modified activity/workflow needs tests, or when mock/dummy clients need to be added or improved.
